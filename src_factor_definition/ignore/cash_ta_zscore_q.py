...
class cash_ta_zscore_q(StockFactorCalculator):
    init_date = 20070101
    category0 = 'fundamental'
    category1 = 'liquidity'
    description = 'cash_ta季度标准化得分'
    
    def calc_factor(self, date: int):
        """计算季度现金资产比的标准化得分
        1. 获取季度现金及现金等价物和总资产数据
        2. 计算比值
        3. 按行业标准化
        """
        # TODO: 需要定义获取财务数据的接口
        cash = TRADE_DATA.get_balance_sheet(date, 'cash_equivalents', 'quarterly')
