...
| Need | Open first |
|------|------------|
| Proj singleton, cwd, instance registry | `src/proj/proj/proj.py`, `src/proj/proj/ins.py` |
| Paths, data roots, config roots | `src/proj/env/path.py`, `src/proj/env/machine.py` |
| Logging, LogFile, file logging | `src/proj/log/logger.py`, `src/proj/log/logfile.py`, `src/proj/proj/files.py` |
...
| Default configs (factor, model, trading, …) | `src/proj/proj/conf/` |
