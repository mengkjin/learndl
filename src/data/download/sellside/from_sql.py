...
factor_settings : dict[str,tuple[tuple[Any,...],dict[str,Any]]] = {
    'dongfang.hfq_chars' : (('dongfang' , 'hfq_chars'  , 'tradingdate' , 20050101 , 20251231 , '%Y%m%d') , {}) ,
    'dongfang.l2_chars'  : (('dongfang' , 'l2_chars'   , 'trade_date'  , 20130930 , 20251231 , '%Y%m%d') , {}) ,
    'dongfang.ms_chars'  : (('dongfang' , 'ms_chars'   , 'trade_date'  , 20050101 , 20251231 , '%Y%m%d') , {}) ,
    'dongfang.order_flow': (('dongfang' , 'order_flow' , 'trade_date'  , 20130930 , 20251231 , '%Y%m%d') , {}) ,
    'dongfang.gp'        : (('dongfang' , 'gp'         , 'tradingdate' , 20170101 , 20251231 , '%Y-%m-%d') , {}) ,
    'dongfang.tra'       : (('dongfang' , 'tra'        , 'tradingdate' , 20200101 , 20251231 , '%Y-%m-%d') , {}) ,
    'dongfang.hist'      : (('dongfang' , 'hist'       , 'tradingdate' , 20200101 , 20251231 , '%Y-%m-%d') , {}) ,
    ...
    'dongfang.factorvae' : (('dongfang' , 'factorvae'  , 'tradingdate' , 20200101 , 20251231 , '%Y-%m-%d') , {}) ,
    ...
    'huayuan.scores_v5' : (('huayuan' , 'scores_v4_style'  , 'trade_dt' , 20171229 , 99991231 , '%Y-%m-%d') , {}) ,
