...
class TSMixer(nn.Module):
    ...
    def __init__(
        ...
        # Embedding
        self.embed = Layer.Patch.LinearPatch(nvars,d_model,patch_len,stride,mask_ratio=0.4,shared=shared_embedding)
...
if __name__ == '__main__':
    ...
    embed = Layer.Patch.LinearPatch(nvars,d_model,patch_len,stride,mask_ratio=0.4,shared=shared_embedding)
