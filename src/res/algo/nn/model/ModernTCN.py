...
class ModernTCN(nn.Module):
    ...
    def __init__(
        ...
        # Embedding
        self.embed = Layer.Patch.ConvolutionalPatch(nvars,d_model,patch_len,stride,shared=shared_embedding)
...
if __name__ == '__main__':
    ...
    from src.res.algo.nn.model.ModernTCN import ModernTCN
    ...
    embed = Layer.Patch.ConvolutionalPatch(nvars , d_model , patch_len=patch_len , stride=stride, shared=True)
