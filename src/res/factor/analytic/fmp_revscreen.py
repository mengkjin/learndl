...
class RevScreenFMPTest(BaseFactorAnalyticTest):
    ...
    def generate(self , factor: StockFactor , benchmark : Any = 'defaults' , verbosity = 2 , **kwargs):
        ...
        self.portfolio_group = PortfolioGroupBuilder('revscreen' , alpha_models , benchmarks , analytic = False , attribution = False , trade_engine = 'yale' , resume = self.resume , resume_path = self.resume_path , caller = self , **self.kwargs)
