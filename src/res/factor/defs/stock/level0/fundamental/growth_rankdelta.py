"""
Growth rank delta factors for stock level0
"""
...
class eps_rank_delta(GrowthFactor):
    init_date = 20110101
...
class sales_rank_delta(GrowthFactor):
    init_date = 20110101
...
class gp_rank_delta(GrowthFactor):
    init_date = 20110101
...
class npro_rank_delta(GrowthFactor):
    init_date = 20110101
...
class dedt_rank_delta(GrowthFactor):
    init_date = 20110101
...
class tax_rank_delta(GrowthFactor):
    init_date = 20110101
...
class roe_rank_delta(GrowthFactor):
    init_date = 20110101
...
class gp_margin_rank_delta(GrowthFactor):
    init_date = 20110101
...
class oper_margin_rank_delta(GrowthFactor):
    init_date = 20110101
...
class net_margin_rank_delta(GrowthFactor):
    init_date = 20110101
...
class ta_rank_delta(GrowthFactor):
    init_date = 20110101
...
class equ_rank_delta(GrowthFactor):
    init_date = 20110101
...
class liab_rank_delta(GrowthFactor):
    init_date = 20110101
...
class cfo_rank_delta(GrowthFactor):
    init_date = 20110101
