"""
Growth YOY Z-score factors for stock level0
"""
...
class eps_yoy_zscore(GrowthFactor):
    init_date = 20110101
...
class sales_yoy_zscore(GrowthFactor):
    init_date = 20110101
...
class gp_yoy_zscore(GrowthFactor):
    init_date = 20110101
...
class npro_yoy_zscore(GrowthFactor):
    init_date = 20110101
...
class dedt_yoy_zscore(GrowthFactor):
    init_date = 20110101
...
class tax_yoy_zscore(GrowthFactor):
    init_date = 20110101
...
class roe_yoy_zscore(GrowthFactor):
    init_date = 20110101
...
class gp_margin_yoy_zscore(GrowthFactor):
    init_date = 20110101
...
class oper_margin_yoy_zscore(GrowthFactor):
    init_date = 20110101
...
class net_margin_yoy_zscore(GrowthFactor):
    init_date = 20110101
...
class cfo_yoy_zscore(GrowthFactor):
    init_date = 20110101
