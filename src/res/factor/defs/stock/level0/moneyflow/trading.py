...
def inflow_by_return(date , n_months : int , direction : Literal[-1,1] , div_amt = True , min_finite_ratio = 0.25):
    ...
    if div_amt:
        inflow /= DATAVENDOR.TRADE.get_volumes(start , end , 'amount' , pivot = True).sum()
    return inflow
...
class flow_small(TradingFactor):
    ...
    def calc_factor(self, date: int):
        ...
        mf   = DATAVENDOR.TRADE.get_mf_data(start , end , ['buy_sm_amount','sell_sm_amount'] , pivot = True)
        net_mf = mf['buy_sm_amount'] - mf['sell_sm_amount']
        net_mf /= DATAVENDOR.TRADE.get_volumes(start , end , 'amount' , pivot = True)
        return net_mf.mean()
...
class flow_medium(TradingFactor):
    ...
    def calc_factor(self, date: int):
        start , end = DATAVENDOR.CALENDAR.td_start_end(date , 1 , 'm')
        mf   = DATAVENDOR.TRADE.get_mf_data(start , end , ['buy_md_amount','sell_md_amount'] , pivot = True)
...
class flow_large(TradingFactor):
    ...
    def calc_factor(self, date: int):
        start , end = DATAVENDOR.CALENDAR.td_start_end(date , 1 , 'm')
        mf   = DATAVENDOR.TRADE.get_mf_data(start , end , ['buy_lg_amount','sell_lg_amount'] , pivot = True)
...
class flow_exlarge(TradingFactor):
    ...
    def calc_factor(self, date: int):
        start , end = DATAVENDOR.CALENDAR.td_start_end(date , 1 , 'm')
        mf   = DATAVENDOR.TRADE.get_mf_data(start , end , ['buy_elg_amount','sell_elg_amount'] , pivot = True)
...
class flow_elsm(TradingFactor):
    ...
    def calc_factor(self, date: int):
        start , end = DATAVENDOR.CALENDAR.td_start_end(date , 1 , 'm')
        mf   = DATAVENDOR.TRADE.get_mf_data(start , end , ['buy_elg_amount','sell_sm_amount'] , pivot = True)
...
class flow_corr_elsm(TradingFactor):
    ...
    def calc_factor(self, date: int):
        start , end = DATAVENDOR.CALENDAR.td_start_end(date , 1 , 'm')
        mf = DATAVENDOR.TRADE.get_mf_data(start , end , ['buy_elg_amount','sell_elg_amount','buy_sm_amount','sell_sm_amount'] , pivot = True)
...
class flow_corr_smlag(TradingFactor):
    ...
    def calc_factor(self, date: int):
        start , end = DATAVENDOR.CALENDAR.td_start_end(date , 22 , 'd')
        mf = DATAVENDOR.TRADE.get_mf_data(start , end , ['buy_sm_amount','sell_sm_amount'] , pivot = True)
        sm = mf['buy_sm_amount'] - mf['sell_sm_amount']
