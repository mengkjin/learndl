...
:class:`~src.api.util.backend.ScriptParamInput`) and :class:`ParamInputsForm`,
...
class ParamInputsForm:
    ...
    item:
        Optional previous :class:`~src.api.util.backend.TaskItem` used to
    ...
    def from_api_endpoint(cls , endpoint , cache : ParamCache | None = None, item : TaskItem | None = None) -> ParamInputsForm:
        ...
        from src.api.interactive.util.api_adapter import stAPIEndpoint
