...
def _script_detail_page_callable(script_key: str):
    ...
    def _run() -> None:
        from src.api.interactive.util.script_detail import show_script_detail
...
def _get_script_page(script_key: str) -> dict:
    ...
    Creates a ``st.Page`` wrapping :func:`~src.api.interactive.util.script_detail.show_script_detail`
