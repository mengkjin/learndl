...
class YAMLFileEditorState:
    ...
    @classmethod
    def get_state(cls , key : str , root : BaseType.strPath | None = None) -> YAMLFileEditorState:
...
class YAMLFileEditor:
    ...
    def __init__(self , key : str = 'yaml_file_editor' , file_root : BaseType.strPath = PATH.main , 
    ...
    def set_file_path(self , file_path : BaseType.strPath) -> None:
        """Update the relative file path in the editor state."""
        self.state.path = str(file_path)

    def get_file_path(self , file_path : BaseType.strPath | None = None) -> Path:
    ...
    def validate_file(self , file_path : BaseType.strPath | None = None) -> None:
    ...
    def load_file(self , file_path : BaseType.strPath | None = None) -> str:
    ...
    def save_file(self , file_path : BaseType.strPath | None = None) -> None:
    ...
    def init_path_input(self , file_path : BaseType.strPath | Sequence[BaseType.strPath] | None = None , default_file : BaseType.strPath | None = None) -> None:
    ...
    @st.fragment
    def show_yaml_editor(self , file_path : BaseType.strPath | Sequence[BaseType.strPath] | None = None , default_file : BaseType.strPath | None = None) -> None:
