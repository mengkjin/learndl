...
def nn(model_module : str , model_param = {} , device : Any = None , state_dict : Optional[dict[str,Tensor]] = {}):
...
def boost(model_module : str , model_param = {} , cuda = None , seed = None , model_dict : Optional[dict] = None):
    ...
    booster = GeneralBooster(model_module , model_param , cuda = bool(cuda) , seed = seed)
