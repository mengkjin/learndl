...
from ..basic import SwiftStorage , Timer
from ..trainer import Device
from ...function.basic import (
    rmdir , tensor_standardize_and_weight , match_values ,
    index_union , index_intersect , forward_fillna ,)
from ...function.date import date_offset
...
class ModelData():
    ...
    def reset_dataloaders(self):        
        ...
        self.loader_storage = SwiftStorage(self.kwarg.storage_type)
